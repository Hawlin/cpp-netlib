...
// Copyright 2013 Linunix (little modification)
...
using sentinel_ptr = std::shared_ptr<boost::asio::io_service::work>;
...
struct thread_pool {
 ...
 protected:
  thread_pool_pimpl* pimpl; // why not use shared_ptr ? rather raw pointer ?
};
